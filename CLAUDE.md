...
tasks in §5, owner-only decisions in §11. `.repoboard/local/docs/HANDOFF.md` is frozen history (§12 closed
2026-09-18); the running record is `.repoboard/`.

**Cold, any seat:** `pnpm build && node packages/server/dist/cli.js seat <name>` — your SEATS
line, last log block, next card, open decisions. Then that card; `docs/BRIEF-TEMPLATE.md` is the
