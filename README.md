...
| **MCP** — `claude mcp add repoboard -- npx repoboard mcp` | tool schema 26.2 KB (29 tools, 2026-09-25, RCB-146) per turn where the harness loads it | ~80 B call, ~200 B result | 7,638 B — the same formatter, to the byte |
