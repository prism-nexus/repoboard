 ...
 * The primary's URL is `/`, never `''`: an empty string resolves against the CURRENT url, query
 * string included, so it can reload whatever repo (or unknown key) is already on screen.
 */
